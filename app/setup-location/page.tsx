...
const MAP_OPTIONS: google.maps.MapOptions = {
  ...
  zoomControl: false, // Turned off for a cleaner mobile UI
...
export default function SetupLocationPage({
  ...
  // 💰 COST-SAVING: Debounced Geocoding
  // Prevents your app from pinging Google 50 times while the user drags the map
  ...
  // 🚀 FIXED: Mobile Click Handling for Autocomplete
  const handlePlaceChanged = () => {
    ...
    // Visually update the input field so the user sees their selection
    if (inputRef.current) {
      inputRef.current.value = newName || newAddress;
      inputRef.current.blur(); // Dismiss the mobile keyboard automatically
    }
  };
  ...
  return (
    ...
    >
      {/* 🚀 FIXED: Search Bar Container (Removed pointer-events-none) */}
          ...
          <div className="flex-1 relative shadow-lg rounded-full bg-white border border-gray-100 h-14 overflow-visible">
            ...
            <Autocomplete
              ...
              options={{
                ...
                // 💰 COST-SAVING: Request only the free/cheap data fields
            ...
            >
              <input
                ...
                onKeyDown={(e) => {
                  // Prevent mobile keyboards from refreshing the page on "Enter"
      ...
      {/* 🚀 FIXED: Map Height Collapse (Added min-h-0 and inset:0) */}
