    ...
    <div className="min-h-screen bg-gray-50/30 flex flex-col font-sans">
      ...
      <main className="container py-8 md:py-12 flex-1 max-w-5xl mx-auto space-y-8 px-4">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
           ...
           <Button variant="outline" className="text-red-600 border-red-100 hover:bg-red-50" onClick={handleLogout}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="border-none shadow-md bg-gradient-to-br from-[#7b1e3a] to-[#5a162b] text-white">
                <CardContent className="p-6 flex items-center justify-between">
                    <div><p className="text-white/70 font-medium text-sm">Total Orders</p><h3 className="text-3xl font-bold mt-1">{totalOrders}</h3></div>
                    <div className="p-3 bg-white/10 rounded-xl"><ShoppingBag className="h-6 w-6 text-white" /></div>
                </CardContent>
            </Card>
            <Card className="border-none shadow-md bg-white">
                <CardContent className="p-6 flex items-center justify-between">
                    <div><p className="text-gray-500 font-medium text-sm">Active Orders</p><h3 className="text-3xl font-bold mt-1 text-[#7b1e3a]">{activeOrders}</h3></div>
                    <div className="p-3 bg-orange-50 rounded-xl"><Clock className="h-6 w-6 text-orange-500" /></div>
                </CardContent>
            </Card>
            <Card className="border-none shadow-md bg-white">
                <CardContent className="p-6 flex items-center justify-between">
                    <div><p className="text-gray-500 font-medium text-sm">Delivered</p><h3 className="text-3xl font-bold mt-1 text-green-600">{completedOrders}</h3></div>
            ...
            <Card className="md:col-span-2 shadow-sm border-gray-200">
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="space-y-2 relative">
                            <div className="flex justify-between items-center">
                                ...
                                <Button variant="ghost" size="sm" className="h-8 text-[#7b1e3a] hover:text-[#7b1e3a]/90 hover:bg-orange-50" onClick={handleUseGPS} type="button">
                            ...
                            <div className="text-xs flex items-center gap-2 mt-1">
                                {coords ? (
                                    <span className="text-green-600 flex items-center font-medium"><MapPin className="h-3 w-3 mr-1" /> Location Pinned</span>
                                ) : (
                    ...
                    <div className="pt-4 flex justify-end">
                        <Button className="bg-[#7b1e3a] hover:bg-[#66172e] text-white min-w-[120px]" onClick={handleSave} disabled={isSaving}>
             ...
             <Card className="shadow-sm border-gray-200 h-fit">
                ...
                <CardContent className="space-y-2">
                    <Button variant="ghost" className="w-full justify-start h-12 text-gray-600 hover:text-[#7b1e3a] hover:bg-orange-50"><Heart className="mr-3 h-5 w-5" /> Favorites</Button>
                    <Separator className="my-2"/>
                    <Button variant="ghost" className="w-full justify-start h-12 text-red-600 hover:text-red-700 hover:bg-red-50">Delete Account</Button>
                </CardContent>
            </Card>
        </div>
      </main>
