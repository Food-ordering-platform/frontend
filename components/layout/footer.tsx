      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">FoodOrder</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-[#7b1e3a]" />
                <span className="text-gray-400">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-[#7b1e3a]" />
                <span className="text-gray-400">support@foodorder.com</span>
              </div>
              <div className="flex items-center gap-3">
                <MapPin className="h-4 w-4 text-[#7b1e3a]" />
                <span className="text-gray-400">123 Food Street, City, State</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 FoodOrder. All rights reserved.
            </p>
